...
def SW_TIRS_coefficients_json():
    ...
    data['TIRS2_10']['water_emissivity'] = 0.992921523229335
    # uncertainty value for ASTER to landsat emis (RIT derived)
    ...
    data['TIRS2_11']['vegetation_coeff'] = 0.9909 # Ray value
...
def main():
    ...
    filepath = '/cis/staff/tkpci/Code/Python/spec_files/'
    
    with open(filepath + "SW_coefficients_ALL.json", "w") as outfile:
        outfile.write(json_object)
    
    
    # load data
    with open(filepath + "SW_coefficients_ALL.json", 'r') as openfile:
