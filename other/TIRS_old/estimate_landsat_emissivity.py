...
def sensor_coefficients(sensor):
    ...
    if sensor == 'TIRS10':
        coefficients={'estimated_1':0.56789,                         #ASTER13:   Tania values 0.56472  Aaron coeff = 0.56789
                               'estimated_2':0.42249,                #ASTER14:   Tania values 0.42545  Aaron Coeff = 0.42249
                               'estimated_3':0.00990,                #intercept: Tania values 0.010103  Aaron Coeff = 0.00990
        ...
        coefficients={'estimated_1':-0.54148252,                     #ASTER13: Tania values  -0.55987    Aaron coeff = -0.54148252 
                               'estimated_2':1.4305094,             #ASTER14: Tania values  1.4465     Aaron Coeff = 1.4305094
                               'estimated_3':0.10916213,            #intercept: Tania values  0.1117      Aaron Coeff = 0.10916213
...
def convertGainBias(dataLandsatASTER,mask,MTL):
    ...
    dataLandsatASTER.setRad('rad3',(dataLandsatASTER.getRad('rad3')) * 0.0000275-0.2)      # convert SR_DC to reflectance
    dataLandsatASTER.setRad('rad4',(dataLandsatASTER.getRad('rad4')) * 0.0000275-0.2)       # convert to reflectance
    dataLandsatASTER.setRad('rad5',(dataLandsatASTER.getRad('rad5')) * 0.0000275-0.2)       # convert to reflectance
    dataLandsatASTER.setRad('rad6',(dataLandsatASTER.getRad('rad6'))* 0.0000275-0.2)       # convert to reflectance
