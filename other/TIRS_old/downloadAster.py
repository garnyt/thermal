...
def downLoadAster(coord, folder = 0):

    if folder == 0:
        folder = '/dirs/data/tirs/downloads/aster/AutoDownloads/'
...
def georegisterAndSaveAster(asterCube, coordsCube, pathrow, filepath = 0):

    if filepath == 0:
        filepath = '/dirs/data/tirs/downloads/aster/E13_E14_NDVI_files/'
