...
def calculateError(T10, T11, e10, e11, a13_std, a14_std):
    ...
    c1_val_b10 = 0.56789  
    c2_val_b10 = 0.42249
    c0_val_b11 = 0.10916213
    c1_val_b11 = -0.54148252 
    c2_val_b11 = 1.4305094
...
def test_scenes():
    ...
    filename = '/cis/staff/tkpci/public_html/SW_scenes/LC08_L1TP_043033_20180930_20200718_02_T1'
    ...
    temp = appTemp_b10_ave
    temp[temp > 0] = 1
    tempave = appTemp_b11_ave
    tempave[tempave > 0] = 1
    diff = temp-tempave
    plt.imshow(diff)
    plt.colorbar()
    ...
    SaveGeotif.saveGeotif(splitwindowLST, '/cis/staff/tkpci/public_html/SW_scenes', 'LC08_L1TP_036026_20141121_20200715_02_T1_SW_LST_new_convolved.tif', wkt_projection, geoTransform)
