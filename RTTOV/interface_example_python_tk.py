...
# See wrapper user guide for gas IDs (page 48)
gas_id_q = 1
gas_id_o3 = 2
gas_id_co2 = 3
...
# set store_rad 2 to get down and upwelling radiance as well (not just total rad)
...
emis_atlas_path = '/dirs/data/tirs/RTTOV/rttov131.common/rtcoef_rttov13/emis_data/'
...
btclear = np.empty((nchannels, nprofiles), order='F', dtype=np.float64)
err = rttov_get_bt_clear(inst_id, btclear)
err = rttov_get_rad_clear(inst_id, btclear)
