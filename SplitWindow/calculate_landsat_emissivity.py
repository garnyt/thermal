...
def main(dataOut):
    ...
    temp_dataOut['ls_emis_data'] = convert_emis_from_ASTER(dataOut, sensor10)
    dataOut['ls_emis_data_10'] = temp_dataOut['ls_emis_data']
    # calculate emssivity
    dataOut['emis10'] = calculate_emissivity(dataOut, temp_dataOut, sensor10)
    dataOut['emis10'][temp_dataOut['mask']] = 0
    
    
    temp_dataOut['ls_emis_data'] = convert_emis_from_ASTER(dataOut, sensor11)
    dataOut['ls_emis_data_11'] = temp_dataOut['ls_emis_data']
    dataOut['emis11'] = calculate_emissivity(dataOut, temp_dataOut, sensor11)
