...
def main(dataOut):
    ...
    if dataOut['water_emis'] == 'no':
        ...
        print('water emissivity used throughout (no ASTER)')
        # check for L8 or L9
        ...
        temp = np.zeros([b10_data.shape[0],b10_data.shape[1]])   
        dataOut['emis10'] = temp + dataOut['variables'][sensor10]['water_emissivity']
        dataOut['emis11'] = temp + dataOut['variables'][sensor11]['water_emissivity']
