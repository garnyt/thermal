...
def runModtran(tape5_name, tape6_name):
    ...
    command = 'mkdir /cis/staff/tkpci/modtran/tape5/'+tape5_name
    os.system(command)
    
    command = 'cp /cis/staff/tkpci/modtran/tape5/'+tape5_name +' /cis/staff/tkpci/modtran/tape5/'+tape5_name+'/tape5' 
    os.system(command) 
   
    command = 'cd /cis/staff/tkpci/modtran/tape5/'+tape5_name+'\n' \
              'ln -s /dirs/pkg/Mod4v3r1/DATA\n' \
              '/dirs/pkg/Mod4v3r1/Mod4v3r1.exe'
    
    os.system(command) 

    command = 'cp /cis/staff2/tkpci/modtran/tape5/'+tape5_name+'/tape6 /cis/staff2/tkpci/modtran/tape6_user_defined_profiles/' + tape6_name 
    os.system(command) 
